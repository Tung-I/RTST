...
public:
  ...
  TIHWDecoder(const uint16_t display_width,
  ...
  TIHWDecoder(const TIHWDecoder & other) = delete;
  const TIHWDecoder & operator=(const TIHWDecoder & other) = delete;
  TIHWDecoder(TIHWDecoder && other) = delete;
  TIHWDecoder & operator=(TIHWDecoder && other) = delete;
