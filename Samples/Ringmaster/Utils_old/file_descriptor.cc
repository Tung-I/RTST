...
size_t FileDescriptor::write(const string& data)
{
  if (data.empty()) {
...
void FileDescriptor::writen(const string& data, const size_t n)
{
...
void FileDescriptor::write_all(const string& data)
{
