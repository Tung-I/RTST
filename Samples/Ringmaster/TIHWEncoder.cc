...
void TIHWEncoder::asyncEncode(ConcurrentQueue<encodeData>& encodeQueue, std::atomic<bool>& encoderWorking, 
...
inline void TIHWEncoder::gatherEncodedData(std::vector<uint8_t>& encOutBuf, 
