    ...
    char *szOutFilePath, NvEncoderInitParam *pEncodeCLIOptions)
{
    ...
    do
    {
        ...
        if (nRead == nFrameSize) 
        {
            ...
            // Reset configure params and codec config every 100 frames
            if (i && i % 100 == 0)
            {
                ...
                // Divide the bitrate by 2 every 200 frames
                if (i % 200 != 0)
                {
